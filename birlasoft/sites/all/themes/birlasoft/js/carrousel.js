...
// initialization
        _init: function (options) {
            ...
            this.box = $('.banner-3dslider');
            this.imgWidth = $('.banner-3dslider .dg-wrapper img').width();
            ...
            var _self = this;
            for (var i = 0, len = this.button.length; i < len; i++) {     // click on the dot
...
// process the href of the intermediate element
...
// Handle click events for left and right elements
